      ...
      if (editor) {
        ...
        for (i in selection) {
          ...
          if (is_img && File.width) {
            lines.push('<img src="' + File.getUrl() + '" data-placeholder="Enter caption here" data-entity-uuid="' + File.uuid + '" data-caption="Enter Caption here" data-entity-type="file" width="' + File.width + '" height="' + File.height + '" alt="' + File.formatName() + '" />');
          }
          // Link
          else {
